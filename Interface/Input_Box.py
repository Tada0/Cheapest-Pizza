...
class InputBox:
    ...
    available_keys_2 = [
        pygame.K_0, pygame.K_1, pygame.K_2, pygame.K_3, pygame.K_4,
        pygame.K_5, pygame.K_6, pygame.K_7, pygame.K_8, pygame.K_9,
        pygame.K_BACKSPACE, pygame.K_ESCAPE, pygame.K_RETURN,
        pygame.K_DELETE, pygame.K_LEFT, pygame.K_RIGHT]
    ...
    def __init__(self, x, y, max_length, width, start_value, type):
        ...
        if type == 'String':
            self.available_keys = InputBox.available_keys_1
        elif type == 'Number':
            self.available_keys = InputBox.available_keys_2
            ...
            if self.active:
                ...
                if event.key not in self.available_keys:
                    ...
                    if len(self.text) < self.max_length:
                        if event.unicode not in InputBox.unsupported_characters:
